...
with open('model/GSindextocoef.pkl','wb') as fp:
    pickle.dump(indextocoef, fp)
    print('dictionary saved successfully to file')

#2)save dictionary : texttoindex
with open('model/GStexttoindex.pkl','wb') as fp:
    pickle.dump(texttoindex, fp)
    print('dictionary saved successfully to file')


#3)Logistic Regression save
filename = 'model/GSlregression.rl'
pickle.dump(lr, open(filename,'wb'))



#modle read
with open('model/GSindextocoef.pkl', 'rb') as fp:
    indextocoef = pickle.load(fp)
indextocoef

with open('model/GStexttoindex.pkl', 'rb') as fp:
    texttoindex = pickle.load(fp)
texttoindex

lr = pickle.load(open('model/GSlregression.rl', 'rb'))
lr.coef_[0]
